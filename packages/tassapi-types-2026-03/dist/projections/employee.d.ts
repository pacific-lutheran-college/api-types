 ...
 */
export type EmployeeSummary = Pick<EmployeeResponse, 'emp_code' | 'first_name' | 'surname' | 'tch_code' | 'cmpy_code'>;
/**
 ...
 */
export type EmployeeCard = Pick<EmployeeResponse, 'emp_code' | 'first_name' | 'surname' | 'preferred_name' | 'position_text' | 'position_title' | 'status_text' | 'tch_code' | 'start_date' | 'cmpy_code'>;
/**
 ...
 */
export type EmployeeContact = Pick<EmployeeResponse, 'emp_code' | 'first_name' | 'surname' | 'e_mail' | 'school_email' | 'mob_phone' | 'phone_w_text' | 'sms_flg'>;
export {};
